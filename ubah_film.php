...
$id = $_GET['id'];
$sql = "SELECT * FROM tabel_movie WHERE id = $id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_sql = "UPDATE tabel_movie SET kode='$kode', nama_film='$nama_film' WHERE id=$id";
...
<form method="POST">
    ...
    <input type="text" name="nama_film" value="<?= $row['nama_film']; ?>" required><br>
